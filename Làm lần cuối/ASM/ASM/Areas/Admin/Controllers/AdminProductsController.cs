...
namespace ASM.Areas.Admin.Controllers
{
    ...
    public class AdminProductsController : Controller
    {
        ...
        public IActionResult Index(int page = 1, int CateId = 0)
        {
            ...
            List<Product> lsCustomers = new List<Product>();
            if (CateId != 0)
            {
                lsCustomers = _context.Products
                 .AsNoTracking()
            ...
            PagedList<Product> models = new PagedList<Product>(lsCustomers.AsQueryable(), pageNumber, pageSize);
